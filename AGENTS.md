# AGENTS.md — DeepPhe Visualizer v2
...
Codex's primary job is to help build, debug, and improve DeepPhe Visualizer v2. This means writing real code, tracing bugs to their root cause, proposing architecture improvements, and implementing features — not just reviewing or advising.
...
These are not optional and must be maintained in any code Codex writes or modifies:
