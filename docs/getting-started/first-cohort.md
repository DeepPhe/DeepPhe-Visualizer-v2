...
If the result reaches zero, remove one of the recent selections or use **Reset filters** to start over.

## 4. Review matching patients

Expand the Selected Patients drawer to inspect the current page. You can search the loaded rows, sort columns, change visible columns, and open a patient.
...
For details, see [Exporting results](../cohort-explorer/exporting-results.md).
